...
import { PlivoCredentialInput } from '../../../services/integrations/types/plivoTypes';

interface PlivoCredentialFormProps {
  initialData?: PlivoCredentialInput;
  onSubmit: (data: PlivoCredentialInput) => Promise<void>;
  onCancel: () => void;
  loading?: boolean;
}

export function PlivoCredentialForm({ 
  initialData, 
  onSubmit, 
  onCancel,
  loading 
}: PlivoCredentialFormProps) {
  const [formData, setFormData] = useState<PlivoCredentialInput>(
