...
import { PlivoCredential } from '../../../services/integrations/types/plivoTypes';
import { cn } from '../../../utils/cn';

interface PlivoCredentialListProps {
  credentials: PlivoCredential[];
  onEdit: (credential: PlivoCredential) => void;
  onDelete: (id: string) => void;
  onManagePhones: (id: string) => void;
}

export function PlivoCredentialList({ credentials, onEdit, onDelete, onManagePhones }: PlivoCredentialListProps) {
  ...
  if (credentials.length === 0) {
    return (
      <div className="text-center py-6 text-gray-500 dark:text-gray-400">
        No credentials found. Add your first Plivo credential to get started.
      </div>
    );
  }
